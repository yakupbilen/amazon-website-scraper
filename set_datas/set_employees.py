...
def set_employees():
    ...
    roles_high = [["Admin",7000,10000,2],["AccessAdmin",8000,12000,1]]
    roles_other = [["DataWriter",4000, 8000,3], ["DataReader", 3000,6000,4],["SalerManager",3000,4500,5], ["Saler",2500,4000,6]]
